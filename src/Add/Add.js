...
class Add extends Component {
    ...
    handleSubmit() {
        ...
        let color = [];
        color.push(ref.state.picker1);
        color.push(ref.state.picker2);
        ref.add(name, color)
    }
                ...
                <div className="container-fluid">
                	<div className="row">
                		<div className="col-12">
                			<div className="card" style={{background: "linear-gradient(to " + this.state.direction + ", " + this.state.picker2 + ", " + this.state.picker1 + ")" }}></div>
                		</div>
                	</div>
                    <div className="row">
